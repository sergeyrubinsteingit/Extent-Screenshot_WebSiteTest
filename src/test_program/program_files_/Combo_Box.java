...
public class Combo_Box { 
	...
	public static String[] menuEntries;
...
public class Combo_Box_Set extends JComboBox<String> {
	...
	public Combo_Box_Set(String[] browsersList_) { // Sets a combobox
		...
		private Combo_Button () {
			...
			this.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if (Default_StartBrowser.webDriver != null) {
						Default_StartBrowser.webDriver.quit();
					}
					System.exit(-1);
				}
			}); // eo ActionListener
...
public static void main(String comboTitle_, String[] browsersList_) throws InterruptedException {
