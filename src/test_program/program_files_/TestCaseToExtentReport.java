...
public class TestCaseToExtentReport extends org.testng.TestListenerAdapter implements org.testng.IInvokedMethodListener, ITestListener 
 {
    ...
    // Creates a test entry in HTML report file [ExtentRepLog.html]
    	extnTest = SetHTMLReporter.extnReports.createTest("Test Case Nmb " + (VisitLinks.linksCounter + 1), 
    			"::: PAGE'S TITLE: " + Start_STR.getPageData[0] + " :::");
    	webDriver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
    // Adds a node to the test entry	
    	extnTestNode = extnTest.createNode("A Node for Test Case Nmb " + (VisitLinks.linksCounter + 1), 
    ...
    @AfterMethod
    public static  void getResult(ITestResult testingResult_) throws IOException {
    	
    	testingResult = testingResult_;
    	
    	if (Start_STR.theFlag == false) {
			TestCaseToExtentReport.testingResult.setStatus(ITestResult.FAILURE);
		}//eoif
